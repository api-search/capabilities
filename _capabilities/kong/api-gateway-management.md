...
source_yaml: "naftiko: 1.0.0-alpha2\ninfo:\n  label: Kong API Gateway Management\n  description: API gateway management workflow for platform engineers to configure services, routes, plugins, consumers, upstreams,\n    and TLS certificates on Kong Gateway instances.\n  tags:\n  - Kong\n  - API Gateway\n  - Configuration\n  created: '2026-04-18'\n  modified: '2026-05-06'\nbinds:\n- namespace: env\n  keys:\n    KONG_ADMIN_URL: KONG_ADMIN_URL\ncapability:\n  consumes:\n  - type: http\n    namespace: kong-admin\n    baseUri: http://localhost:8001\n    description: Kong Gateway Admin API for gateway configuration.\n    resources:\n    - name: information\n      path: /\n      description: Gateway node information.\n      operations:\n      - name: get-node-info\n        method: GET\n        description: Retrieve node information including version and plugins.\n        inputParameters: []\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n\
  \          value: $.\n      - name: get-node-status\n        method: GET\n        description: Retrieve node status including connections and database.\n        inputParameters: []\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n    - name: services\n      path: /services\n      description: Upstream service management.\n      operations:\n      - name: list-services\n        method: GET\n        description: List all services.\n        inputParameters: []\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n      - name: create-service\n        method: POST\n        description: Create a new service.\n        inputParameters: []\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n        body:\n          type: json\n          data:\n            name: '{{tools.name}}'\n\
  ...
  \          description: Certificate ID.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n        body:\n          type: json\n          data:\n            cert: '{{tools.cert}}'\n            key: '{{tools.key}}'\n      - name: delete-certificate\n        method: DELETE\n        description: Delete a certificate.\n        inputParameters:\n        - name: certificate_id\n          in: path\n          type: string\n          required: true\n          description: Certificate ID.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n    - name: tags\n      path: /tags\n      description: Tag-based entity filtering.\n      operations:\n      - name: list-tags\n        method: GET\n        description: List all tags and entities.\n        inputParameters: []\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n\
