...
source_yaml: "naftiko: 1.0.0-alpha2\ninfo:\n  label: Ampersand Integration Management\n  description: Workflow capability for product developers and platform engineers to manage SaaS integrations, connections,\n    installations, and destinations programmatically through the Ampersand platform.\n  tags:\n  - Ampersand\n  - Integration Management\n  - SaaS Integrations\n  - Developer Tools\n  - FinOps\n  created: '2026-04-19'\n  modified: '2026-05-06'\nbinds:\n- namespace: env\n  keys:\n    AMPERSAND_API_KEY: AMPERSAND_API_KEY\ncapability:\n  consumes:\n  - type: http\n    namespace: ampersand-api\n    baseUri: https://api.withampersand.com\n    description: Ampersand public REST API for managing integrations and connections.\n    authentication:\n      type: apikey\n      key: X-Api-Key\n      value: '{{AMPERSAND_API_KEY}}'\n      placement: header\n    resources:\n    - name: installations\n      path: /1/projects/{projectIdOrName}/integrations/{integrationId}/installations\n      description:\
  \ Manage integration installations for end-user connections.\n      operations:\n      - name: list-installations\n        method: GET\n        description: List all installations for an integration.\n        inputParameters:\n        - name: projectIdOrName\n          in: path\n          type: string\n          required: true\n          description: Project ID or name.\n        - name: integrationId\n          in: path\n          type: string\n          required: true\n          description: Integration ID.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n      - name: create-installation\n        method: POST\n        description: Create a new installation for an integration.\n        inputParameters:\n        - name: projectIdOrName\n          in: path\n          type: string\n          required: true\n          description: Project ID or name.\n        - name: integrationId\n          in: path\n        \
  \  type: string\n          required: true\n          description: Integration ID.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n        body:\n          type: json\n          data:\n            groupRef: '{{tools.groupRef}}'\n            config: '{{tools.config}}'\n    - name: connections\n      path: /1/projects/{projectIdOrName}/connections\n      description: Manage OAuth connections to third-party SaaS providers.\n      operations:\n      - name: list-connections\n        method: GET\n        description: List all connections in a project.\n        inputParameters:\n        - name: projectIdOrName\n          in: path\n          type: string\n          required: true\n          description: Project ID or name.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n    - name: destinations\n      path: /1/projects/{projectIdOrName}/destinations\n\
  \      description: Manage data destinations for integration data delivery.\n      operations:\n      - name: list-destinations\n        method: GET\n        description: List all destinations in a project.\n        inputParameters:\n        - name: projectIdOrName\n          in: path\n          type: string\n          required: true\n          description: Project ID or name.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n      - name: create-destination\n        method: POST\n        description: Create a new destination for integration data delivery.\n        inputParameters:\n        - name: projectIdOrName\n          in: path\n          type: string\n          required: true\n          description: Project ID or name.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n        body:\n          type: json\n          data:\n   \
  \         name: '{{tools.name}}'\n            type: '{{tools.type}}'\n            config: '{{tools.config}}'\n    - name: integrations\n      path: /1/projects/{projectIdOrName}/integrations\n      description: Manage SaaS integration definitions.\n      operations:\n      - name: list-integrations\n        method: GET\n        description: List all integrations in a project.\n        inputParameters:\n        - name: projectIdOrName\n          in: path\n          type: string\n          required: true\n          description: Project ID or name.\n        outputRawFormat: json\n        outputParameters:\n        - name: result\n          type: object\n          value: $.\n    - name: providers\n      path: /1/providers\n      description: List available SaaS provider connectors.\n      operations:\n      - name: list-providers\n        method: GET\n        description: List all available SaaS providers supported by Ampersand.\n        outputRawFormat: json\n        outputParameters:\n \
