...
source_yaml: "naftiko: 1.0.0-alpha2\ninfo:\n  label: Amazon IoT Events - Iot Event Management\n  description: Unified capability for IoT Developer, Solutions Architect to manage detect and respond to events from iot sensors\n    and applications operations.\n  tags:\n  - IoT\n  - AWS\n  - Event Detection\n  - Automation\n  created: '2026-04-19'\n  modified: '2026-05-06'\nbinds:\n- namespace: env\n  keys:\n    AWS_ACCESS_KEY_ID: AWS_ACCESS_KEY_ID\n    AWS_SECRET_ACCESS_KEY: AWS_SECRET_ACCESS_KEY\ncapability:\n  consumes:\n  - type: http\n    namespace: iot-events\n    baseUri: https://iotevents.amazonaws.com\n    description: Amazon IoT Events REST API\n    authentication:\n      type: apikey\n      key: Authorization\n      value: '{{AWS_ACCESS_KEY_ID}}'\n      placement: header\n    resources:\n    - name: resources\n      path: /\n      description: Amazon IoT Events resources\n      operations:\n      - name: list-detector-models\n        method: GET\n        description: List Detector\
