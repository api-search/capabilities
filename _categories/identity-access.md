...
- assign-role
- list-permissions
description: 'Identity management, authentication, authorization, single sign-on,

  role-based access control, federated identity. Often abbreviated IAM.
...
- security
- compliance
short: Manage users, roles, and authorization across systems.
