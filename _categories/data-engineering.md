...
- list-streams
- submit-statement
description: 'Capabilities for ingesting, transforming, and loading data — ETL/ELT

  pipelines, change data capture, streaming ingestion, data integration.

  Distinguished from analytics by the focus on movement and shape rather

  than query and visualization.
...
- capability_name: Apache Oozie Workflow Orchestration
  ...
  - Pipeline Management
  tool_count: 12
- capability_name: Apache Pig Data Processing Workflow
  capability_slug: pig-workflow
  capability_url: https://capabilities.apis.io/capabilities/apache-pig/pig-workflow/
  consumed_api_count: 0
  operation_count: 2
...
- analytics
- object-storage
short: Move, transform, and stage data through pipelines (ETL/ELT).
