...
- list-dashboards
- list-metrics
description: 'Capabilities that ingest, transform, and query datasets to produce metrics,

  reports, dashboards, or ad-hoc analyses. Distinguished from raw query/SQL

  APIs by a focus on aggregation, summarization, and presentation.
...
- capability_name: Apache Kylin OLAP Analytics
  ...
  - OLAP
  tool_count: 5
- capability_name: Apache Pinot Analytics Workflow
  capability_slug: pinot-workflow
  capability_url: https://capabilities.apis.io/capabilities/apache-pinot/pinot-workflow/
...
- data-engineering
- monitoring
short: Analyze, query, and visualize datasets to surface insights.
slug: analytics
---
