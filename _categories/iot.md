...
- get-telemetry
- send-command
description: 'Capabilities for fleets of connected devices — registration, configuration,

  OTA updates, telemetry ingestion, edge compute coordination.
...
- messaging
- monitoring
short: Register, configure, monitor, and ingest telemetry from connected devices.
slug: iot
---
