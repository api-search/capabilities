# capabilities.apis.io — Naftiko Capability Specs

[**capabilities.apis.io**](https://capabilities.apis.io) indexes [Naftiko capability specs](https://github.com/naftiko/framework/wiki/Specification) — YAML files that compose one or more APIs into business workflows and expose them as REST APIs, MCP servers, and agent skills. Each capability is runnable: pull the YAML, set credentials, run with the Naftiko engine.

**Live site:** [https://capabilities.apis.io](https://capabilities.apis.io)

## What's in this repo

- **`_capabilities/, _categories/`** — one Markdown file per capability (organized by provider) plus cross-provider category pages aggregating capabilities by domain (analytics, monitoring, security, payments, etc.).
